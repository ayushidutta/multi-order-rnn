...
_DATASET_DIR = '/home/ayushi/Git/research/imageAnnotation/data/nuswide'
_SPLIT_NAMES = ['train','test','valid']
_DATA_FILENAMES = ['nus1_train_list.txt','nus1_test_list.txt','nus1_test_list.txt']
_LABEL_FILENAMES = ['nus1_train_annot.txt','nus1_test_annot.txt','nus1_test_annot.txt']
_MODEL_DIR = os.path.join(_DATASET_DIR,'caffe-res1-101')
_RESULTS_DIR = os.path.join(_MODEL_DIR,'sigmoid_logits_1')
_FTR_FILENAMES = ['nus1_train_r101.mat','nus1_test_r101.mat','nus1_test_r101.mat']
_PROB_FILENAMES = ['nus1_train_r101_pred.mat','nus1_test_r101_pred.mat','nus1_test_r101_pred.mat']
_NUM_PER_SHARD = 50000
_IMAGE_DIRECTORY = '/home/ayushi/Git/research/dataset/nuswide/images/Flickr'
_TFRECORD_SUB_DIRECTORY=os.path.join(_MODEL_DIR,'tfrecord1_1')
